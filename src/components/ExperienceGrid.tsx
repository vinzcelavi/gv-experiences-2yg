  ...
  return (
    <div className="flex-1">
      ...
      <div className="flex items-center justify-between gap-4 mb-2">
        <div className="relative min-w-0 -ml-2">
          ...
          <div
            className="pointer-events-none absolute left-0 top-0 h-full w-2 z-10 bg-gradient-to-r from-secondary to-transparent"
          />
          <div
            className="pointer-events-none absolute right-0 top-0 h-full w-12 z-10 bg-gradient-to-r from-transparent to-secondary"
          />
        </div>
